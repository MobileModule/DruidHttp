...
import com.druid.http.tools.HeaderUtils;
...
public class DruidHttpHeaders extends BasicMultiValueMap<String, String> {

    public static final String IGNORE_TOKEN_KEY = "IGNORE-TOKEN";
     ...
     */
    public void setAll(DruidHttpHeaders headers) {
